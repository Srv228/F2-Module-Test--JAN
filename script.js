...
selected.addEventListener('click',()=>{show(selected)},{once: true})
let name
let email
let user
let flag=true
...
function validate(e){
    ...
    p3.innerText="You can now click on second image !"
    obj['one']=true
    if(obj['one']==true){
        secondPic()
    }
...
function secondPic(){
    ...
    function details(){
        ...
        p4.innerText="You can now click on third image !"
        obj['two']=true
        ...
        function roll(){   
                ...
                if(min==3){
                    ...
                    if(sum<=10 && flag==true){
                        ...
                        p7.innerText="Try Again by clicking on third image !"
                        p7.style.color="red"
                    }
                        ...
                        p7.classList.remove('hide')
                        p7.innerText="Congo ! Click on fourth image to get your coupon."
                        p7.style.color='green'
                        obj['three']=true
                        if(obj['one']==true && obj['two']==true && obj['three']==true){
                            fourthpic()
                        }
                    }
                }
